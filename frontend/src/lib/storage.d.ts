...
export function loadAdminWorkspaceReturn(): any | null;
export function saveAdminWorkspaceReturn(payload: any): void;
export function clearAdminWorkspaceReturn(): void;
