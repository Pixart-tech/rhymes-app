...
const CarouselContent = React.forwardRef<any, any>(({ className, hasSpacing = true, ...props }, ref) => {
...
const CarouselItem = React.forwardRef<any, any>(({ className, hasSpacing = true, ...props }, ref) => {
